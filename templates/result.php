...
<html>
	...
	<body>
		...
		<p>
			<?php 
				echo '<img src="https://graph.facebook.com/me/picture" alt="picture of me">and<img src="https://graph.facebook.com/'.$fb_id.'/picture" alt="picture of '.$fb_id.'"> Match Percentage is <strong>'.$percent.'</strong>';
			?>
		</p>
